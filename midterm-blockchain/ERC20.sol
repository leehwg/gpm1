...
interface IERC20 {
    ...
    // Returns a boolean value as a result of a VinpearlLand transaction
    function transferVinpearl(address _customer, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20 {
    ...
    function transferVinpearl(address _customer, address recipient, uint256 tokensAmount) public override returns (bool) {
